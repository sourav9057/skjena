        ...
        <nav className="navbar-wrapper">
            <div className="navbar-topbar">
                ...
                <ul className="navbar-socials">
                    <li>
                        <a href="https://www.linkedin.com/in/sk-jena" target="_blank" rel="noreferrer">
                            <img src={LinkedIn} alt="LinkedIn" />
                        </a>
                    </li>
                    <li>
                        <a href="https://github.com/sourav9057" target="_blank" rel="noreferrer">
                            <img src={GitHub} alt="GitHub" />
                        </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/_shadow_2711/" target="_blank" rel="noreferrer">
                            <img src={Instagram} alt="Instagram" />
                        </a>
                    </li>
                    <li>
                        <a href="https://x.com/Sourav9057" target="_blank" rel="noreferrer">
            ...
            <div className={`navbar-menubar ${menuOpen ? "open" : ""}`}>
                <ul className="navbar-links">
                    <li>
                        <a href="#home" className={`home-link ${activeSection === "home" ? "active" : ""}`}>
                            <FaHome className="nav-icon home-icon" /> Home
                        </a>
                    </li>
                    <li>
                        <a href="#about" className={`about-link ${activeSection === "about" ? "active" : ""}`}>
                    ...
                    <li>
                        <a
                            href="#education"
                            className={`education-link ${activeSection === "education" ? "active" : ""}`}
                        >
                    ...
                    <li>
                        <a
                            href="#experience"
                            className={`experience-link ${activeSection === "experience" ? "active" : ""}`}
                        >
                    ...
                    <li>
                        <a
                            href="#skills"
                            className={`skills-link ${activeSection === "skills" ? "active" : ""}`}
                        >
                    ...
                    <li>
                        <a
                            href="#projects"
                            className={`projects-link ${activeSection === "projects" ? "active" : ""}`}
                        >
